  ...
  return (
    <div>
     ...
     <form className='flex flex-col p-4 m-4 justify-center align-middle text-black'>
      <input type='text' placeholder='Name' className='border-2 p-2 m-2 rounded-lg'/>
      <input type="email" placeholder='Email'  className='border-2 p-2 m-2 rounded-lg'/>
      <textarea placeholder='Message' name='Meaasage'  className='border-2 p-2 m-2 rounded-lg'/>
